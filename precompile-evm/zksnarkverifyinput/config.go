...
// adds specific configuration for ZksnarkVerifyInput.
type Config struct {
...
// ZksnarkVerifyInput with the given [admins] as members of the allowlist .
...
// that disables ZksnarkVerifyInput.
...
// Key returns the key for the ZksnarkVerifyInput precompileconfig.
